...
import { Question, Choice, Language } from '../types';
...
export const QuestionRenderer: React.FC<QuestionRendererProps> = ({ 
  ...
  const renderScale = (showDK?: boolean, showNR?: boolean) => (
      ...
      <div className="min-h-[44px] flex items-center justify-center pt-2">
        {typeof value === 'number' ? (
          <div className="text-center animate-in fade-in zoom-in duration-300">
             ...
             >
                {value}: {RATING_DESCRIPTORS[value][lang]}
             </span>
          </div>
        ) : (
  ...
  switch (question.type) {
    ...
    case 'rating-0-10-nr':
      return renderScale(false, true);

    case 'rating-0-10-dk':
      return renderScale(true, false);
